  ...
  if (editorialManaged) {
    ...
    if (imageReady) {
      checks.push(check(
        ...
        '記事画像',
        CHECK_OK,
        `旧5記事参照 ${IMAGE_STYLE_TEMPLATE} / GPT Image + exact typography / Brand QA PASS。`
      ));
    } else {
      const msg = 'Reference V2のThumbnail / OGPがまだ完成していません。旧5記事参照・画像用短縮コピー・versioned asset・Brand QA PASSが揃うまで公開できません。';
