  ...
  if (editorialManaged) {
    ...
    if (imageReady) {
      checks.push(check(
        ...
        '記事画像',
        CHECK_OK,
        `旧5記事参照 ${IMAGE_STYLE_TEMPLATE} / supplied photo locked / exact typography / Brand QA PASS（series + relevance + source fidelity）。`
      ));
    } else {
      const msg = 'Reference V2.2のThumbnail / OGPがまだ完成していません。提供素材の保持・画像用短縮コピー・記事との意味一致・versioned asset・Source Fidelity QA PASSが揃うまで公開できません。';
