  ...
  if (editorialManaged) {
    ...
    if (imageReady) {
      checks.push(check(
        ...
        '記事画像',
        CHECK_OK,
        `旧5記事準拠 ${IMAGE_STYLE_TEMPLATE} / versioned Thumbnail+OGP / QA PASS。`
      ));
    } else {
      const msg = '旧5記事準拠の文字入りThumbnail / OGPがまだ完成していません。Classic V1・画像用短縮コピー・versioned asset・QA PASSが揃うまで公開できません。';
