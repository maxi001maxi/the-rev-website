...
function generationPrompt(attempt) {
  ...
  return [
    ...
    '- The eventual layout uses this scene on the RIGHT half of a quiet editorial card, so keep the customer and meaningful environment readable in a right-side crop.',
